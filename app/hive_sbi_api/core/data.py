...
FAILED_TRX_NOT_SYNCED_ACCOUNT = 6
FAILED_TRX_NOT_SYNCED_SPONSOR = 7
...
FAILED_TRX_TYPE_CHOICES = (
    ...
    (FAILED_TRX_NOT_SYNCED_ACCOUNT, _('Not synced account')),
    (FAILED_TRX_NOT_SYNCED_SPONSOR, _('Not synced sponsor')),
)
